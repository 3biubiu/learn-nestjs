...
async function downloadPdf() {
  let delEl = [
    '#juejin > div.book-read-view > section > div.book-content > div > div.book-content__header > div.user-auth',
    '#juejin > div.book-read-view > section > div.book-summary > div.book-summary-inner > div.book-summary__footer',
    '#juejin > div.book-read-view > section > div.book-content > div > div.book-body.transition--next > div > div.section-content > div > section'
  ]
  delEl.forEach(selector => {
  ...
  console.log(`%c content `, 'color:#fff;background:#a2d7ff;font-weight:bold;padding:2px;border-radius: 5px', await content);

}
downloadPdf()
addScript('chrome-extension://mpiodijhokgodhhofbcjdecpffjipkle/lib/single-file.js', downloadPdf)